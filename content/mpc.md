...
1. **Definition**: A computation is defined by a developer within the context of an MPC eXecution Environment (MXE). It specifies inputs, outputs, operations, and access permissions.
