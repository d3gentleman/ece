...
export default async function TopicPage({ params }: { params: Promise<{ topic: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white p-8 max-w-4xl mx-auto">
      ...
      <div className="prose prose-invert prose-indigo max-w-none prose-headings:font-bold prose-h1:text-4xl prose-h1:mb-8 prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-p:text-zinc-400 prose-p:leading-relaxed prose-p:mb-6 prose-strong:text-zinc-200 prose-li:text-zinc-400">
        <ReactMarkdown remarkPlugins={[remarkGfm]}>
          {content}
        </ReactMarkdown>
        
        <div className="my-12 p-8 border border-zinc-800 rounded-2xl bg-zinc-900/40">
